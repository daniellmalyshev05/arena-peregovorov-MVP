...
4. Ты не соглашаешься на сделку по собственному желанию. Решение о принятии предложения принимает система и сообщает тебе отдельно.
...
proposedDeal заполняй только если ты сам предлагаешь изменить условия. stateDelta — от −8 до 8.${
