...
/**
 * Имя собеседника из админки — во всех текстах кейса: бриф, досье, гипотезы,
 * разбор.
 *
 ...
 * («она готова», «настроена партнёрски») — нет. Имя другого пола не
 * применяется: участник видит библиотечного персонажа, администратор —
