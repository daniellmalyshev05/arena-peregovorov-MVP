...
export interface HiddenInterest {
   ...
   * раскрытия игроку предлагается оценить именно его — одним кликом.
   */
  probe?: string
...
export interface Scenario {
   ...
   * под полем ввода и вставляются в него по клику. Скрытых интересов не
   * называют: это приёмы, а не подсказки к ответу.
   */
  openers?: string[]
  /**
...
export interface NegotiationState {
   ...
   * этого не меняется, меняется только формулировка в разборе.
   */
  endedEarly?: boolean
  /**
