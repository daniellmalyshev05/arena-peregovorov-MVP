 ...
 *
 *   1. «Принимаю» в ходе без пакета ловится и переписывается;
 *   2. условия, названные в чате, попадают в подсказку «соберите пакетом»;
 *   3. «Скажите прямо, чего вы хотите?» не открывает скрытый интерес.
 */
