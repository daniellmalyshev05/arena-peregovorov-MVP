/**
 * Настройка администратора доходит до сервера.
 *
 * Раньше /api/turn всегда брал библиотечный кейс: сложность, тон, имя, роль,
 * число раундов и установка администратора жили только в браузере. На живом
 * прогоне вторая сторона из ссылки с именем «Ирина Соколова» ответила
 * «Я Марина, кстати». Проверки админки этого не ловили — они гоняли applyConfig,
 * а не обработчик маршрута. Эта проверка бьёт в сам обработчик.
 */
