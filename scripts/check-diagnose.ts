/**
 * Главный вывод разбора: заголовок должен быть верным во всех исходах,
 * а не только в удачном.
 *
 * Случай «ценность создана, но досталась не вам»: 99% созданной ценности,
 * 8,1 выигрыша при справедливой доле 20,1 — это не «Сильная сделка».
 */
...
// 4. Ценность создана, но досталась не вам.
{
  const deal: Deal = {
