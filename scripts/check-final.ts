/**
 * Финальная проверка 23 сентября — прогон как жюри.
 *
 * Каждая строка — косяк, который был виден на проде:
 *   1. ловушка в досье сразу после интереса, который её подтверждает;
...
console.log('✓ косяки финальной проверки закрыты')
