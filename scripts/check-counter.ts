 ...
 *
 * На живом прогоне модель назвала встречные условия сама, игрок собрал ровно
 * их — и получил отказ: движок об этом встречном ничего не знал. Здесь для
 * каждого кейса перебираются пакеты, на которые вторая сторона отвечает
